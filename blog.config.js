...
const BLOG = {
  API_BASE_URL: process.env.API_BASE_URL || 'https://vpn-share.com/api/v3', // API默认请求地址,可以配置成自己的地址例如：https://[xxxxx].notion.site/api/v3
  // Important page_id！！！Duplicate Template from  https://tanghh.notion.site/02ab3b8678004aa69e9e415905ef32a5
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID ||
    '1bad167f61018137bb89000c45303494',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Alpha', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'VPN服务全景评测😘', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://vpn-share.com', // 网站地址
